...
min_fare_range, max_fare_range = range_cols[0].slider("Lowset Fare", float(min_fare), float(max_fare),
                                        [float(min_fare), float(max_fare)])

min_fare_range, max_fare_range = range_cols[2].slider("Lowset Age", float(min_age), float(max_age),
...
if embark:
    res = check_rows("Embarcked", embark)
